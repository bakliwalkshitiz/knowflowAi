...
public class SecurityConfig {
    ...
    @Value("${cors.allowed-origins:http://localhost:5173,http://localhost:3000,https://knowflow-ai-eight.vercel.app}")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        if (!origins.contains("https://knowflow-ai-eight.vercel.app")) origins.add("https://knowflow-ai-eight.vercel.app");
        if (!origins.contains("https://*.vercel.app")) origins.add("https://*.vercel.app");

        configuration.setAllowedOriginPatterns(origins);
        configuration.setAllowedMethods(List.of("GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"));
        configuration.setAllowedHeaders(List.of("*"));
        configuration.setExposedHeaders(List.of("Authorization", "Content-Type", "X-OpenAI-Api-Key"));
